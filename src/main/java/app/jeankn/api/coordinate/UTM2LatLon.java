...
class UTM2LatLon
{
    ...
    public Coordinate convertUTMToLatLong( String utmString )
    {
        Log.d("UTM", utmString);
        Coordinate c = Coordinate.FromDD(0,0);
        String latZone;
        int zone;
        ...
        Coordinate coordinate = Coordinate.FromDD(latitude, longitude);
        Log.d("LatLng", coordinate.ToDD().ToString());
        return coordinate;
    }
